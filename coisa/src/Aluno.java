...
public class Aluno {
     ...
     * 
	 * @return uma String da lista de laboratorios que o aluno tem conta
     */
	...
	public void cadastraDisciplina(String nomeDisciplina, int numNotas) {
		...
		System.out.printf("Disciplina %s com %d notas e pesos {%s} cadastrada com sucesso!\n", nomeDisciplina, numNotas, pesos);
	}
	...
	public void cadastraDisciplina(String nomeDisciplina) {
		...
		System.out.printf("Disciplina %s com 4 notas e pesos {1, 1, 1, 1, } cadastrada com sucesso!\n", nomeDisciplina);
	}
	...
	public void cadastraNota(String nomeDisciplina, int nota, double valorNota) {
		...
		System.out.printf("Nota %d de valor %.2f na disciplina %s\n", nota, valorNota, nomeDisciplina);
	}
	...
	/**
     * Retorna lista das representacoes em String das disciplinas
     * que o aluno esta cursando.
     * 
	 * @return uma String da lista de disciplinas que o aluno esta cursando
     */
	 ...
	 * @return uma String da lista de disciplinas que o aluno esta cursando
     */
	public String listaCantina() {
		String lista = "";
		for (ContaCantina i : this.contasCantina) {
			lista += i.toString() + "\n";
		}
		return lista;
	}
	...
	public void defineSaudeMental(String valor) {
		...
		System.out.printf("Sua saúde mental está %s!/n", valor);
	}
	...
	public void defineSaudeFisica(String valor) {
		...
		System.out.printf("Sua saúde física está %s!/n", valor);
	}
